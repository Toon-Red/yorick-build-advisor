...
MATCHUP_TABLE: dict[str, MatchupInfo] = {
    ...
    "Fiora": MatchupInfo(
        ...
        advice="Iceborn rush. She parries W — never W predictably. Fight only with 4 ghouls + Maiden. Hug walls to deny vitals.",
    ),
    ...
    "Gwen": MatchupInfo(
        ...
        advice="Her W zone makes ghouls useless. Fight OUTSIDE her W. Weak early, strong mid. W her, walk out of W zone. Phase Rush escapes her R slow.",
    ),
    ...
    "Irelia": MatchupInfo(
        ...
        advice="BAN HER. Her Q one-shots ghouls and stacks passive. W to cancel Q chain. Iceborn + anti-heal rush.",
    ),
    "Jax": MatchupInfo(
        difficulty="HARD",
        ...
        shard_override="MS",
        exhaust_viable=True,
        advice="Iceborn rush. W him when he Es to trap him. MS shard critical (350 vs 340). Aery+Bramble trick viable.",
    ),
    "Jayce": MatchupInfo(
        difficulty="Medium",
    ...
    "Kennen": MatchupInfo(
        ...
        advice="Poke with E+ghouls. Don't stack near ghouls (he stuns everyone). W him when he Es in for R. Bramble+Aery trick.",
    ),
    "Kled": MatchupInfo(
        difficulty="HARD",
    ...
    "Renekton": MatchupInfo(
        ...
        tags=("vs_fighter", "vs_lane_bully"),
        exhaust_viable=True,
        advice="Insane early burst with empowered W. Iceborn rush + Bone Plating mandatory. Don't fight at 50+ fury. Survive to 2 items.",
    ),
    "Riven": MatchupInfo(
        difficulty="HARD",
    ...
    "Smolder": MatchupInfo(
        ...
        advice="He scales hard — punish early. Zone with ghouls. Push for plates. E max Eclipse if you want to all-in.",
    ),
    "Swain": MatchupInfo(
        difficulty="Medium",
    ...
    "Trundle": MatchupInfo(
        ...
        shard_override="MS",
        advice="His R steals stats — don't R first. Tiamat rush into BC. Executioner's if he builds Ravenous Hydra.",
    ),
    "Tryndamere": MatchupInfo(
        difficulty="EXTREME",
        keystones=("Grasp-2", "Grasp-1", "Grasp-3", "Conqueror"),
        item_category="iceborn_cleaver",
        tags=("vs_fighter", "vs_crit", "vs_split"),
        shard_override="MS",
        exhaust_viable=True,
        summoner_spells="Exhaust/TP",
        advice="Iceborn rush + Titanic. Exhaust mandatory. W him when he spins in. Disengage when he ults (5s).",
    ),
    "Udyr": MatchupInfo(
        difficulty="Medium",
    ...
    "Vayne": MatchupInfo(
        ...
        shard_override="AF",
        advice="She kites and shreds with %HP true damage. Second Wind + D Shield. Bramble+Aery trick. Outscale at 2 items.",
    ),
